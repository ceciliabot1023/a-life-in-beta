...
var config_default = defineConfig({
  contentApiUrlOverride: true ? "http://localhost:4001/graphql" : `https://content.tinajs.io/content/${process.env.NEXT_PUBLIC_TINA_CLIENT_ID}/github/${process.env.TINA_BRANCH}`,
  branch: "main",
